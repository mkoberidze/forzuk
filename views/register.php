...
<form method="post" action="/register">
    <div class="form-group">
        ...
        <input type="text" class="form-control <?php echo isset($errors['registeruser']) ? ' is-invalid' : '' ?>"
               value="<?php if (isset($_SESSION['registeruser'])) echo $_SESSION['registeruser']; else echo ""; ?>"
               name="registeruser">
        ...
        <input type="text" class="form-control <?php echo isset($errors['surname']) ? ' is-invalid' : '' ?>"
        ...
        <input type="text" class="form-control <?php echo isset($errors['email']) ? ' is-invalid' : '' ?>" id="email"
               name="email"
        ...
        <input type="password" class="form-control <?php echo isset($errors['passwd']) ? ' is-invalid' : '' ?>"
        ...
        <input type="password" name="checkpass"
               class="form-control <?php echo isset($errors['checkpass']) ? ' is-invalid' : '' ?>"
